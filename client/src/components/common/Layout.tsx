...
export default function Layout(props: Props) {
  const { children, wrap, flex, flexBasis, column, margin, padding, center, classes, align, ...extraProps } = props
  ...
  const getFlexChildClasses = () => {
    ...
    const [justifyString, alignString] = align.split(' ')
    const alignStyle = getAlignClass(alignString)
    const justifyStyle = getJustifyClass(justifyString)
